...
// SQL作成&実行
$sql = 'INSERT INTO PHP_SSK_child (user_id, name, birthday, height,weight,created_at, updated_at,child_id) VALUES (:user_id, :name, :birthday, :height,:weight,now(), now(),NULL,)';
